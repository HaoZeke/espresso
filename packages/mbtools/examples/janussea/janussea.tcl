...
lappend vmdcommands "mol representation CPK 1.000000"
...
set moltypes [subst { 0 hollowsphere  { $sphereatoms } { 0 } { 100 } }]
	
	# Seeding 
expr srand ([pid])
set pos_x [expr rand()*22]
	set pos_y [expr rand()*22]
	set pos_z [expr rand()*22]

	part 1 pos $pos_x $pos_y $pos_z q 0.0 type 1
...
append tablenames sr_e10_c25.tab
